        ...
        child: Material(
          ...
          child: SizedBox(
            ...
            child: ListView.builder(
              ...
              ,itemBuilder:(ctx,i)=> Padding(padding: const EdgeInsets.symmetric(horizontal: 40),
              child: GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    border: i==selectedIndex? const Border(top: BorderSide(width: 3,color: Colors.white)):null,
                  ...
                  child: Icon(data[i],size: 35,color: i==selectedIndex?Colors.white:Colors.brown,),
                ),
              ),
            ),
